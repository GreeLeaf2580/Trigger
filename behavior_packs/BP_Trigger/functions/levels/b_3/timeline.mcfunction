...
execute unless blocks -62 13 65   -62 13 65   -53 20 61 all if block 17 22 7 concrete_powder ["color"="gray"] if score Idea3ItemGot data matches 0 run function levels/idea_3/notice
