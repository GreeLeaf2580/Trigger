...
#如果a1里被占用（-17 22 6为40 19 25的禁止进入），且a1里没有人，则解除占用
    ...
    #如果是表示通过的绿色混凝土粉末，则替换为石头按钮和黄色混凝土粉末
...
#如果a3里被占用（-17 24 6为40 19 25的禁止进入），且a3里没有人，则解除占用
    #如果是表示未通过的黄色混凝土粉末，则替换为石头按钮和黄色混凝土粉末
    execute if blocks 40 19 25  40 19 25   -17 24 6 all unless entity @a[scores={class=1,grade=3}] if block -17 23 7 concrete_powder ["color"="yellow"] run clone 40 17 26   40 17 25   -17 24 6 replace force

    #如果是表示通过的绿色混凝土粉末，则替换为石头按钮和黄色混凝土粉末
    execute if blocks 40 19 25  40 19 25   -17 24 6 all unless entity @a[scores={class=1,grade=3}] if block -17 23 7 concrete_powder ["color"="green"] run clone 40 16 26   40 16 25   -17 24 6 replace force