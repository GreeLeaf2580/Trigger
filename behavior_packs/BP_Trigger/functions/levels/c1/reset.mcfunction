#被该关卡选中的玩家显示提示信息
tellraw @a[scores={class=3,grade=1}] {"rawtext": [{"text":"[C1]"},{ "translate": "tellraw.reset" }]}
...
#给予被选中玩家物品
    #给予“提示”
    execute as @a[scores={class=3,grade=1}] at @s run replaceitem entity @s slot.hotbar 6 trigger:hint 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"}}
