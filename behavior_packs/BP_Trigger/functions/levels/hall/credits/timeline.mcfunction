...
## [280] 测试人员名单
execute if score dialogue active matches 6 if score dialogue time matches 280 run titleraw @a[scores={grade=-1}] title {"rawtext":[{"text":"Echeng 嘉睿 墨痕 \n量筒 鸽子 巴豆 \n小飞侠 lanos等"}]}
