...
#如果b1里被占用（-19 22 6为40 19 25的禁止进入），且b1里没有人，则解除占用
    ...
    execute if blocks 40 19 25  40 19 25   -19 22 6 all unless entity @a[scores={class=2,grade=1}] if block -19 22 7 stained_hardened_clay ["color"="lime"] run  clone 40 16 23   40 16 23   -19 22 6 replace force
...
#如果b2里被占用（-19 23 6为40 19 25的禁止进入），且b2里没有人，则解除占用
    ...
    #如果是表示通过的黄绿色陶瓦，则替换为木头按钮和黄绿色陶瓦
    execute if blocks 40 19 25  40 19 25   -19 23 6 all unless entity @a[scores={class=2,grade=2}] if block -19 23 7 stained_hardened_clay ["color"="lime"] run  clone 40 16 23   40 16 23   -19 23 6 replace force
...
#如果b3里被占用（-19 24 6为40 19 25的禁止进入），且b3里没有人，则解除占用
    ...
    #如果是表示通过的黄绿色陶瓦，则替换为木头按钮和黄绿色陶瓦
    execute if blocks 40 19 25  40 19 25   -19 24 6 all unless entity @a[scores={class=2,grade=3}] if block -19 24 7 stained_hardened_clay ["color"="lime"] run  clone 40 16 23   40 16 23   -19 24 6 replace force
