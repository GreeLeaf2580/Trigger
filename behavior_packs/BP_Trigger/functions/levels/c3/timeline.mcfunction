...
execute if blocks -54 10 87   -54 10 87   -50 19 92 all if block 19 22 7 stained_hardened_clay ["color"="cyan"] if score Idea2ItemGot data matches 0 run function levels/idea2/notice
