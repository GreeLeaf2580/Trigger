...
execute if entity @a[scores={class=3,grade=3},hasitem={item=minecraft:gold_ingot,quantity=30}] if block 19 22 7 stained_hardened_clay ["color"="cyan"] if score Idea2ItemGot data matches 0 run function levels/idea2/notice
