...
#将被该关卡选中的玩家显示标题
titleraw @a[scores={class=3,grade=3}] title { "rawtext": [{ "translate": "title.c3.name" }] }
...
#给予被选中玩家物品
    #给予“提示”
    execute as @a[scores={class=3,grade=3}] at @s run replaceitem entity @s slot.hotbar 6 trigger:hint 3 0 {"minecraft:item_lock":{"mode":"lock_in_slot"}}
