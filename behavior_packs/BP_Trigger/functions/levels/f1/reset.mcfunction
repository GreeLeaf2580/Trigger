...
#将被该关卡选中的玩家显示标题
titleraw @a[scores={class=6,grade=1}] title { "rawtext": [{ "translate": "title.f1.name" }] }
...
#给予被选中玩家物品
    #给予“提示”
    execute as @a[scores={class=6,grade=1}] at @s run replaceitem entity @s slot.hotbar 6 trigger:hint 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"}}
