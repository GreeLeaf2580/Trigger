...
#开启接下来的关卡，修改大厅关卡显示
    ...
    #显示通过该类型
    execute if block -21 25 7 concrete_powder ["color"="gray"] run function levels/c_3/cheer

    execute if score Idea2ItemGot data matches 1 run function levels/idea_2/unlock