...
#给予被选中玩家物品
    #给予“提示”
    execute as @a[scores={class=1,grade=1}] at @s run replaceitem entity @s slot.hotbar 6 trigger:hint 2 0 {"minecraft:item_lock":{"mode":"lock_in_slot"}}
...
#如果20 22 7为石英柱，即hide1未解锁过，重置解锁hide1的区域
    #重置箱子及其内容物“念”
