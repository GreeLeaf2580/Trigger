...
## 清除开发者物品
execute if score developerMode settings matches 0 run clear @a template:change_to_creative
execute if score developerMode settings matches 0 run clear @a template:change_to_survival
execute if score developerMode settings matches 0 run clear @a template:change_to_adventure
execute if score developerMode settings matches 0 run clear @a template:change_to_spectator
## 重置gamerule
execute if score developerMode settings matches 0 run function lib/modify_data/init_gamerule
